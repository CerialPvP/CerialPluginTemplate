...
public class Utils {
    private static final String PREFIX = "<gradient:#485fcf:#bea6ff><b>ParticleLib</b></gradient> <dark_gray>|<dark_gray> <reset>";
    ...
    public static void sendMessage(CommandSender sender, String string, Object... args) {
        sender.sendMessage(format(PREFIX+string, args));
    }

    public static void sendError(CommandSender sender, String string, Object... args) {
        sender.sendMessage(format(PREFIX+" <#ee4444>" + string, args));
    }
